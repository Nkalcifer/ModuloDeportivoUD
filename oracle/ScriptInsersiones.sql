...
-- INSERT INTO ASISMIEMBROEQUIPO (CONMIEMBROEQUIPO, CONSECPROGRA, CONSEEQUIPO, ITEMMIEMBRO) VALUES ();

-- SELECT ME.CONSEEQUIPO, ME.ITEMMIEMBRO
...
-- WHERE ME.CONSEEQUIPO = E.CONSEEQUIPO
-- AND ME.CODESTU=ES.CODESTU
-- AND ME.CODESTU= '20211015112'
-- AND D.IDDEPORTE=E.IDDEPORTE
-- AND ME.CONSEEQUIPO= '3'
-- AND ED.CODESPACIO = ESP.CODESPACIO;

-- SELECT CODESPACIO, NOMESPACIO
-- FROM ESPACIO
...
-- SELECT DISTINCT E.NOMESTU Nombre, E.APELESTU Apellido
-- FROM ASISTIRRESPONSABLE AR, RESPONSABLE R, ESTUDIANTE E
-- WHERE AR.CONSECRES=R.CONSECRES
-- AND E.CODESTU=R.CODESTU

-- SELECT E.CODESTU CODIGO, E.NOMESTU||' '||E.APELESTU NOMBRES, ES.NOMESPACIO SEDE, P.IDPERIODO PERIODO, COUNT(E.NOMESTU)*2 HORAS
